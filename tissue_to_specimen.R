# get tissue/specimen relationships from OBI
...
obi <-
  rdflib::rdf_parse(doc = "http://purl.obolibrary.org/obo/obi.owl", format = "rdfxml")
...
system.time(tissue.specimen.result <-
              rdflib::rdf_query(rdf = obi, query = tissue.specimen.query))
